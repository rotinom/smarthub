...
class SmarthubFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return SmarthubOptionsFlowHandler(config_entry)
...
class SmarthubOptionsFlowHandler(config_entries.OptionsFlow):
    """Config flow options handler for smarthub."""
